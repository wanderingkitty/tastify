...
const SideBar: React.FC<SideBarProps> = ({
  ...
  // Используем пропс если передан, иначе локальное состояние
  const isDarkmode =
    propIsDarkmode !== undefined ? propIsDarkmode : localDarkmode;
  ...
  return (
    <div
      className={`menu-side-container ${isDarkmode ? "dark" : "light"}`}
      id="sidebar"
    >
      ...
      <div className="menu-items">
        <button
          ...
          onClick={() => handleNavigationClick("/homepage")}
        >
          <svg
        ...
        <button className="action-btn">
          ...
          <p onClick={() => handleNavigationClick("/recipes-page")}>
            Your recipes
          </p>
        </button>
        <button className="action-btn">
        ...
        <button className="action-btn">
          ...
          <p onClick={() => handleNavigationClick("/shopping-list")}>
            Shopping list
          </p>
        </button>
        <button className="action-btn">
